  ...
  const handleFormSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://mapi.pcor.me/api/auth/payment/send.php",
        {
          sekaiValue,
          price,
        },
  ...
  return (
    <div className="max-w-md mx-auto dark:bg-gray-800 dark:text-white min-h-screen">
      ...
      <div className={`${currentStep == 1 ? "block" : "hidden"} py-8 px-5`}>
        ...
        <p className="dark:text-gray-300 text-gray-700 mt-4">코인 보내기</p>
      ...
      <div className={`${currentStep == 3 ? "block" : "hidden"} py-8 px-5`}>
        ...
        <div class="flex flex-col items-center">
          <img
            src={`https://ticketplus.injeonmetro.co.kr/plusCard/${
              currentStep === 3 ? sekaiValue : "adminofplco"
            }_card.png`}
            alt="받는 사람 등록카드"
            class="h-24 my-8"
      ...
      <div className={`${currentStep == 4 ? "block" : "hidden"} py-8 px-5`}>
        ...
        <div class="flex flex-col items-center">
          <img
            src={`https://ticketplus.injeonmetro.co.kr/plusCard/${
              currentStep === 4 ? sekaiValue : "adminofplco"
            }_card.png`}
            alt="받는 사람 등록카드"
            class="h-24 my-8"
            onError={handleImageError}
