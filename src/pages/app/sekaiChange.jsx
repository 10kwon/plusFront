...
export const SekaiChangePage = (props) => {
  ...
  const handleFormSubmit = async () => {
    try {
      // 데이터를 PHP 서버로 전송
      const response = await axios.post("https://mapi.pcor.me/api/auth/sekai/change.php", {
        sekaiValue
      },
      {
...
: <span></span>}
                 <button             
                onClick={currentStep !== 2 ? handleNextStep : handleFormSubmit}
