...
export const CashShopPage = (props) => {
  const [shopData, setShopData] = useState([]);
  useEffect(() => {
    axios.get('https://mapi.pcor.me/api/board/shopPopularCash.php')
  ...
  useEffect(() => {
    axios.get('https://mapi.pcor.me/api/board/shopInventoryCash.php', {
  ...
  useEffect(() => {
    axios.get('https://mapi.pcor.me/api/board/shopListCash.php')
            ...
            <div className="absolute inset-0 overflow-hidden">
              <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                ...
                >
                  ...
                  <h3 class="font-bold text-2xl text-blue-500 dark:text-blue-300">{selectedProduct.price.toLocaleString()}원</h3>
                  </div>
                  ...
                  <div class="bg-red-100 dark:bg-red-950 dark:text-white rounded-xl px-2 py-2 text-center mb-4">
                    <ExclamationCircleIcon class="h-6 w-6 text-red-500 dark:text-red-300 inline-block mr-1"/> 미성년자의 거래 시 미성년자 또는 법정 대리인에 의해 plus@sqlare.com으로 계정의 닉네임 또는 ID와 송금확인증을 보내면 아이템 비활성화 및 감가상각을 조건으로 환불받을 수 있어요.
                  </div>
            ...
            >
              <Dialog.Panel className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                <div className="md:rounded-xl relative flex w-full items-center overflow-hidden bg-white dark:bg-gray-800">
                  ...
                  {isPopupOpen && (
                  <Iframe url={`https://mapi.pcor.me/form/buy_cash.php?iid=${selectedProduct.iid}`}
        id=""
