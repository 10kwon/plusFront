...
<img src="/resources/images/qloat.png" alt="Qloat" className="h-6 w-auto text-white inline-block mr-2"/>  Qloat으로 로그인하기 <span className="inline-flex items-center rounded-xl px-2 ml-2 text-white bg-gradient-to-r from-blue-500 to-purple-500 ring-1 ring-inset ring-blue-700/10">
        예정
            ...
            <a href="https://discordapp.com/api/oauth2/authorize?client_id=1028652743440736317&redirect_uri=https%3A%2F%2Fnmapi.pcor.me%2Foauth%2Fdiscord&response_type=code&scope=identify">
  <button
  ...
  <a href="https://nmapi.pcor.me/oauth/kakao?action=login">
  <button
  ...
  <a href="https://nmapi.pcor.me/oauth/google?action=login">
  <button
  ...
  <a href="https://nmapi.pcor.me/oauth/twitter?action=login">
  <button
 ...
 <path d="m236 0h46l-101 115 118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123-113-148h94.9l65.5 86.6zm-16.1 244h25.5l-165-218h-27.4z"/>
  ...
  <a href="https://nmapi.pcor.me/oauth/ip?action=login">
  <button
