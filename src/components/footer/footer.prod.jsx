...
<a href="https://github.com/Plus-Platforms" class="transform ease-in duration-100 active:scale-95 active:bg-gray-100 text-gray-500 hover:text-gray-900 dark:hover:text-white">
...
<a href="https://www.youtube.com/channel/@PlusPlatforms" class="transform ease-in duration-100 active:scale-95 active:bg-gray-100 text-gray-500 hover:text-red-500 dark:hover:text-white">
